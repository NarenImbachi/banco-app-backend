...
public class MovimientoController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<Movimiento>> registrarMovimiento(@Valid @RequestBody CreateMovimientoRequest request) {
        ...
        return new ResponseEntity<>(ApiResponse.success(movimientoRegistrado, "Movimiento registrado exitosamente"), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<ApiResponse<List<Movimiento>>> obtenerPorCuenta(@PathVariable Long cuentaId) {
        ...
        return new ResponseEntity<>(ApiResponse.success(movimientos, "Movimientos obtenidos exitosamente"), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ApiResponse<List<Movimiento>>> obtenerPorRangoFechas(
        ...
        log.info("GET /api/movimientos/cuenta/{}/rango - Obteniendo movimientos entre {} y {}", cuentaId, fechaInicio, fechaFin);
        List<Movimiento> movimientos = movimientoQueryUseCase.obtenerPorRangoFechas(cuentaId, fechaInicio, fechaFin);
        return new ResponseEntity<>(ApiResponse.success(movimientos, "Movimientos en rango obtenidos exitosamente"), HttpStatus.OK);
    }
